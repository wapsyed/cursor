...
-   **Quem**: Quais são os **países** que menos vacinaram em cada **continente**?

-   **Quando**: Será que **sempre** foi assim ou é algo **recente** dos últimos 5 anos?

-   **Pandemia**: Será que a pandemia afetou a vacinação contra outras doenças?

-   **Comparações**:Qual seria a média de vacinação contra uma doença x para o continente y e onde esses países estão? (Dica: use `group_by()` e `summarize()`)
