...
Ao usarmos a regressão linear com todos os países, desconsideramos os **agrupamentos** dados pelas regiões da OMS. Afinal, cada região tem variabilidade entre seus países, e na média, uma região pode ter um comportamento diferente da outra. Podemos ver isso fazendo uma regressão linear por região e por ano.
