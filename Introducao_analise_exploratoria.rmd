...
Aparentemente, quando a cobertura vacinal para a BCG aumenta, a expectativa de vida também aumenta.

Agora, troque a variável do eixo x por PIB.
...
ggplot() +
  ...
  geom_point(shape = "circle") +
  facet_wrap(~year)+
  scale_x_continuous(trans = "log10", labels = unit_format(unit = "K", scale = 1e-3))+
  theme_minimal() +
  labs(title = "Cobertura vacinal e PIB per capita",
       subtitle = "Vacina BCG", 
       x = "PIB per capita",
       y = "Cobertura vacinal (%)",
       color = "Região",
